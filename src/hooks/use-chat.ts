...
import { collection, addDoc, query, orderBy, onSnapshot, Timestamp, getDocs, deleteDoc, doc } from 'firebase/firestore';
...
export function useChat(secret: string | null, sessionId: string | null) {
  ...
  const sendFileMessage = useCallback(async (
    ...
    const placeholderContent = `[pending file transfer]`;
